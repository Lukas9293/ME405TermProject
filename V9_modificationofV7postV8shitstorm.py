...
def closed_loop_task():
    ...
    while True:
        ...
        if elapsed_ticks < 6700:  # straight: l=-10, r=-21
            ...
            controller.kp = 12; controller.ki = 0; controller.kd = 0
            section = 1
            ...
            alpha = 0.7; deadband = 0.01; correction_multiplier = 3.0
            base_left = -10; base_right = -22; left_offset = -5; right_offset = 5
            controller.kp = 11; controller.ki = 0; controller.kd = 0
            section = 3    
        ...
        elif elapsed_ticks < 33775:  # straight: l=-10, r=-21
            alpha = 0.8; deadband = 0.01; correction_multiplier = 3.0
            base_left = -10; base_right = -21; left_offset = -5; right_offset = 5
            controller.kp = 10; controller.ki = 0; controller.kd = 0
            section = 5    
            section_name = 'wall bump'
        elif elapsed_ticks < 34625:  # right turn: l=-20, r=15, ticks = 850
            alpha = 0.8; deadband = 0.01; correction_multiplier = 3.0
            base_left = -20; base_right = 15; left_offset = -5; right_offset = 5
            controller.kp = 10; controller.ki = 0; controller.kd = 0
            section = 6
            section_name = 'wall right'
        elif elapsed_ticks < 36625:  # straight: l=-10, r=-21
            alpha = 0.8; deadband = 0.01; correction_multiplier = 3.0
            base_left = -10; base_right = -21; left_offset = -5; right_offset = 5
            controller.kp = 10; controller.ki = 0; controller.kd = 0
            section = 7
            section_name = 'wall straight'
        elif elapsed_ticks < 37375:  # left turn: l=-5, r=-20, offsets: 0, 5; duration: 690 ticks
            alpha = 0.8; deadband = 0.01; correction_multiplier = 3.0
        ...
        #elif elapsed_ticks < 39375:  # straight: l=-10, r=-21
         #   alpha = 0.8; deadband = 0.01; correction_multiplier = 3.0
          #  base_left = -10; base_right = -21; left_offset = -5; right_offset = 5
           # controller.kp = 10; controller.ki = 0; controller.kd = 0
            #section = 9  
            #section_name = 'wall straight 2'
        #elif elapsed_ticks < 40150:  # left turn: l=-5, r=-20, offsets: 0, 5; duration: 690 ticks
         #   alpha = 0.8; deadband = 0.01; correction_multiplier = 3.0
          #  base_left = -5; base_right = -20; left_offset = 0; right_offset = 5
           # controller.kp = 10; controller.ki = 0; controller.kd = 0
            #section = 10
            #section_name = 'wall left 2'
        
        elif elapsed_ticks < 40000:  # straight: l=-10, r=-21
            alpha = 0.8; deadband = 0.01; correction_multiplier = 3.0
...
ir_sensor_task_obj = cotask.Task(ir_sensor_task, name="IRSensorTask", priority=2, period=30, profile=True)
closed_loop_task_obj = cotask.Task(closed_loop_task, name="ClosedLoopTask", priority=2, period=40, profile=True)
